"""
Source: https://github.com/ternaus/imread_benchmark/blob/master/imread_benchmark/benchmark_single.py
Benchmark libraries: cv2, skimage, PIL, simplejpeg, imageio
...
def print_package_versions():
    packages = ["opencv-python", "pillow-simd", "simplejpeg", "scikit-image", "imageio"]
...
def main():
    ...
    libraries = ["opencv", "PIL", "simplejpeg", "skimage", "imageio", "torch"]
