...
if __name__ == "__main__":
    ...
    if args.amp:
        train_amp(model, loss_fn, optimizer, train_dataloader_, val_dataloader_, n_epochs=args.n_epochs)
    else:
        train(model, loss_fn, optimizer, train_dataloader_, val_dataloader_, n_epochs=args.n_epochs)
