...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.bn1 = nn.BatchNorm2d(32, affine=False)  # to be replaced with SyncBatchNorm
...
if __name__ == "__main__":
    ...
    init_process(local_rank, fn=run_training, backend="gloo")  # replace with "nccl" afterwards
